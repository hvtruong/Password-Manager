...
const UpdatePasswordForm = () => {
    ...
    const createNewPassword = async (e) => {
        ...
        if (!validNewPassword) {
            ...
            try {
                const response = await addNewPassword({ passwordName, oldPassword, newPassword })
                if (response.error) {
    ...
    return (
        <div className='modal fade' id='updatePasswordForm' tabIndex='-1' aria-labelledby='updatePasswordForm'>
                ...
                <form className='box needs-validation' onSubmit={createNewPassword}>
                    ...
                    <div className='modal-body'>
                        ...
                        <input
                            ...
                            required={newPassword || repeatNewPassword ? true : false}
                        />
                        ...
                        <input
                            ...
                            required={oldPassword || repeatNewPassword ? true : false}
                        />
